...
public class ContractsHistory {
    ...
    public ContractsHistory(ContractsHistoryWithid p) {
        id = p.getId();
        ...
        CallTariffsDAO b = new CallTariffsDAO();
        SmsTariffsDAO c = new SmsTariffsDAO();
        InternetTariffsDAO d = new InternetTariffsDAO();
        account = a.getById(p.getAccountId());
        callTariff = b.getById(p.getCallTariffId());
        smsTariff = c.getById(p.getSmsTariffId());
        internetTariff = d.getById(p.getInternetTariffId());
    }
    @Id
